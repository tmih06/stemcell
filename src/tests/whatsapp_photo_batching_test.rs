...
mod tests {
    ...
    async fn test_buffer_single_photo() {
        ...
        let count = state
            .buffer_photo(&phone, "<<IMG:/tmp/img1.jpg>>".to_string(), None)
            .await;
        assert_eq!(count, 1);
    ...
    async fn test_buffer_multiple_photos() {
        ...
        state
            .buffer_photo(
                &phone,
                "<<IMG:/tmp/img1.jpg>>".to_string(),
                Some("First caption".to_string()),
            )
            .await;
        state
            .buffer_photo(&phone, "<<IMG:/tmp/img2.jpg>>".to_string(), None)
            .await;
        state
            .buffer_photo(&phone, "<<IMG:/tmp/img3.jpg>>".to_string(), None)
            .await;
    ...
    async fn test_multiple_phones_independent_buffers() {
        ...
        state
            .buffer_photo(&phone1, "<<IMG:/tmp/img1.jpg>>".to_string(), None)
            .await;
        state
            .buffer_photo(&phone2, "<<IMG:/tmp/img2.jpg>>".to_string(), None)
            .await;
        state
            .buffer_photo(&phone2, "<<IMG:/tmp/img3.jpg>>".to_string(), None)
            .await;
    ...
    async fn test_caption_selection_first_non_empty() {
        ...
        state
            .buffer_photo(
                &phone,
                "<<IMG:/tmp/img3.jpg>>".to_string(),
                Some("Actual caption".to_string()),
            )
            .await;
    ...
    async fn test_rapid_photo_upload_simulation() {
        ...
        assert!(
            !tokens[4].1.is_cancelled(),
            "Last token should not be cancelled"
        );
